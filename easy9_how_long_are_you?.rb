...
# Input: a String
# Output: an Array that contains every word from the string, to which we've appended a space and the word length.

# ALGO
# separate string by 1 space w/ String#split
# map thru the array & transform each element (word) by appending a space followed by the word.length
